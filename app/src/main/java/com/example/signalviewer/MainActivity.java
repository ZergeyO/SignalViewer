...
public class MainActivity extends AppCompatActivity {
    ...
    public final String STR_KEY_AMP = "AMPLITUDE_VALUE";
    public final String STR_KEY_FREQ = "FREQUENCY_VALUE";
    public final String STR_KEY_PHASE = "PHASE_VALUE";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button_goToGraphs.setOnClickListener(view -> {
            try {
                ...
                Log.d(LOG_TAG, String.valueOf(intent.getDoubleExtra(this.STR_KEY_AMP, 0.1)));
